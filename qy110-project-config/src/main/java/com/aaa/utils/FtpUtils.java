...
public class FtpUtils {
    ...
    public static Boolean upload(String host, Integer port, String username, String password, String basePath,
        ...
        //1.创建临时路径
        String tempPath="";
        //2.创建FtpClient对象（这个对象及时Ftp给java所提供的API）
        ...
        try {
            ...
            if (!ftpClient.changeWorkingDirectory(basePath+filePath)){
                ...
                for (String dir : split) {
                    ...
                    //12.拼接临时路径（如果没有进入if，则取到的值应该是2020）
                    tempPath += "/" + dir;
    ...
    @Test
    public void test(){
        File file=new File("D:/宋伊人.jpg");
        try {
            InputStream inputStream = new FileInputStream(file);
            Boolean upload = FtpUtils.upload("192.168.61.23",
                    21,
                    "ftpuser",
                    "4593138",
                    "/home/ftp/",
